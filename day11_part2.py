def calculate_total_galaxy_distance_v2(input):
...
#...#....."""
ans1 = 82000210
assert calculate_total_galaxy_distance_v2(test1.splitlines()) == ans1

# Read input
with open("day11.txt") as f:
    lines = f.read().splitlines()
    print(calculate_total_galaxy_distance_v2(lines))
